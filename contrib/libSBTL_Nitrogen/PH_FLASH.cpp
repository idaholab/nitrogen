...
//
SBTLAPI void __stdcall PH_FLASH_DERIV_N2(double p, double v, double vt, double u, double& dvdp_h, double& dvdh_p, double& dpdh_v, double& dudp_h, double& dudh_p, double& dpdh_u) throw()
{
