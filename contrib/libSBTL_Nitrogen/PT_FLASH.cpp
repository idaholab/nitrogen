...
extern "C" void __stdcall DIFF_T_VU_N2_TT(double vt, double u, double& t, double& dtdv, double& dtdu, double& dudv);
//
...
//
SBTLAPI int __stdcall PT_FLASH_DERIV_N2(double p, double t, double& v, double& vt, double& dvdp_t, double& dvdt_p, double& dpdt_v, double& u, double& dudp_t, double& dudt_p, double& dpdt_u) throw()
{
    static const double df_p=1.e-10; //rel. deviation in p
    static const double df_t=1.e-10; //abs. deviation in t
...
//
SBTLAPI int PT_FLASH_N2_T(double p, double t, double& vt, double& u) throw()
{
